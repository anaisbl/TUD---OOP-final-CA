#new bank menu
#saving account only can do 1 withdrawal or one transfer per month, no negative balance allowed
#checking account  can have negative balance up to specific limit, let's say -200
...
#make operation (deposit, withdrawal)
